...
class SuspendController extends controllerBase_1.ControllerBase {
    constructor() {
        super();
    }
    read(userInfo, take, skip) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            try {
                result = yield this.prismaClient.suspend.findMany({
                    take,
                    skip,
                    where: condition,
                    select: {
    ...
    drop(userInfo, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            try {
                result = yield this.prismaClient.suspend.deleteMany({
                    where: {
                        AND: condition
                    }
                });
...
exports.default = SuspendController;
